...
path = "/home/gaofei/PycharmProjects/ElectroMagnetArea/18and7area/megedData.txt"
...
tf_x = tf.placeholder(tf.float32, [None, TIME_STEP * INPUT_SIZE])  #(128,9)     # shape(batch, 784)
image = tf.reshape(tf_x, [-1, TIME_STEP, INPUT_SIZE])  #(128,1,9)                 # (batch, height, width, channel)
tf_y = tf.placeholder(tf.int32, [None, CLASS_NUM])   #(128,4)                          # input y
