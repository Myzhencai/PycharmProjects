...
# 加載所有數據
path = "/home/gaofei/PycharmProjects/tf2rnnlstm/DatafromH3/7Areadata/megedData.txt"
...
for step in range(80000):    # training
    ...
    if step == 79999:
        ...
        saver.save(sess, save_path="/home/gaofei/PycharmProjects/tf2rnnlstm/DatafromH3/Modelfile/Matrixnew")
