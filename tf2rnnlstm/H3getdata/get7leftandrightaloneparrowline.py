...
if __name__ == '__main__':
    ...
    rithtsavepath = "./right/"
    #
    # left_thread = threading.Thread(target=serialleft,args=(area,test,leftsavepath,))
    # right_thread = threading.Thread(target=serialrifht,args=(area,test,leftsavepath,))
    # all_thread = threading.Thread(target=seriaall,args=(area,test,leftsavepath,rithtsavepath,))

    seriaall(area,test,leftsavepath,rithtsavepath)
    # 开启线程
    # all_thread.start()
    # right_thread.start()