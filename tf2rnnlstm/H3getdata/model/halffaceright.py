...
# 加載所有數據
path = "/home/gaofei/PycharmProjects/tf2rnnlstm/H3getdata/data/right/megedData.txt"
...
for step in range(8000):    # training
    ...
    if step == 7999:
        ...
        saver.save(sess, save_path="/home/gaofei/PycharmProjects/tf2rnnlstm/H3getdata/H3rightfaceDemo/ModelFile/Matrixright")
