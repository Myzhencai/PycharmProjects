...
sess=tf.Session()
#先加载图和参数变量
saver = tf.train.import_meta_graph('/home/rer/H3leftfaceDemo/singelleftnew/Matrixleft.meta')
saver.restore(sess, tf.train.latest_checkpoint('/home/rer/H3leftfaceDemo/singelleftnew'))
