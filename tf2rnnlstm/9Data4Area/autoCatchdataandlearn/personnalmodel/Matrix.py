...
if __name__ == '__main__':
    ...
    saver = tf.train.import_meta_graph('/home/rer/personnalmodel/rightface/Matrixrightbi.meta')
    saver.restore(sessright, tf.train.latest_checkpoint('/home/rer/personnalmodel/rightface'))
    ...
    saver = tf.train.import_meta_graph('/home/rer/personnalmodel/leftface/Matrixleftbi.meta')
    saver.restore(sessleft, tf.train.latest_checkpoint('/home/rer/personnalmodel/leftface'))
