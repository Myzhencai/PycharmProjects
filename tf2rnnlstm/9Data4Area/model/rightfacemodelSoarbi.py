...
# 加載所有數據
path = "/home/gaofei/PycharmProjects/tf2rnnlstm/9Data4Area/data/Soarrightbi/megedData.txt"
...
for step in range(8000):    # training
    ...
    if step == 7999:
        ...
        saver.save(sess, save_path="/home/gaofei/PycharmProjects/tf2rnnlstm/9Data4Area/modelresult/Soarrightbi/SoarMatrixrightbi")
