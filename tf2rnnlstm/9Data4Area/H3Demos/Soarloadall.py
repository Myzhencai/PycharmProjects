...
if __name__ == '__main__':
    ...
    saver = tf.train.import_meta_graph('/home/rer/H3Demos/Soarrightbi/Soarrightbi/SoarMatrixrightbi.meta')
    saver.restore(sessright, tf.train.latest_checkpoint('/home/rer/H3Demos/Soarrightbi/Soarrightbi'))
    ...
    saver = tf.train.import_meta_graph('/home/rer/H3Demos/Soarleftbi/Soarleftbi/SoarMatrixleftbi.meta')
    saver.restore(sessleft, tf.train.latest_checkpoint('/home/rer/H3Demos/Soarleftbi/Soarleftbi'))
