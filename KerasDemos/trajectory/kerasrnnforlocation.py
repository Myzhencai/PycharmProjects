...
BATCH_INDEX = 0
OUTPUT_SIZE = 3  # 輸出location
CELL_SIZE = 180  # RNN中隐藏单元
LR = 0.001  # 学习率
...
path = "/home/gaofei/PycharmProjects/KerasDemos/locposmag/reciver_to_sender_6dofwithmag.txt"
...
y_testnew = y_test[:16000]
X_testnew = X_test[:16000]

y_test_last = y_test[16000:]
X_test_last = X_test[16000:]
# ---------------------------创建RNN神经网络---------------------------
# 创建RNN模型
model = Sequential()
...
result = model.predict(X_test_last)
different = y_test_last - result
print(different)
